...
g++ %SDL2_PROJECT_NAME%.cpp -I%SDL2_LATEST_VER_ROOT%\%SDL2_INCLUDE_PATH% -L%SDL2_LATEST_VER_ROOT%\%SDL2_LIB_PATH% %SDL2_LINKER_OPTIONS% %SDL2_LIBRARIES% -o %SDL2_PROJECT_NAME%.exe
