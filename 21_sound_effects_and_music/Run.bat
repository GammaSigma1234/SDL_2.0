...
set SDL2_TTF___DLL=D:\Dati\SDL2\SDL2_ttf-2.20.0\x86_64-w64-mingw32\bin\
set SDL2_MIXER_DLL=D:\Dati\SDL2\SDL2_mixer-2.6.1\x86_64-w64-mingw32\bin\
...
:Path_SDL2_Add
  ...
  echo.
  SET PATH=%PATH%;%SDL2_DLL_LATEST_VER_PATH%;%SDL2_IMAGE_DLL%;%SDL2_TTF___DLL%;%SDL2_MIXER_DLL%
