...
@REM Project's name
set SDL2_PROJECT_NAME=50_SDL_and_opengl_2
...
set SDL2_LIB_PATHS=-L%SDL2_LIB_PATH% -L%SDL2_IMAGE_LIB_PATH% -L%OPENGL32_LIB_PATH% &:: -L%SDL2_TTF_LIB_PATH%
set SDL2_LIBRARIES=-lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lGlU32 -lOpenGL32 &:: -lSDL2_ttf
...
set SDL2_INCLUDE_PATHS=-I%SDL2_INCLUDE_PATH% -I%SDL2_IMAGE_INCLUDE_PATH% -I%OPENGL32_INCLUDE_PATH%&:: -I%SDL2_TTF_INCLUDE_PATH%
